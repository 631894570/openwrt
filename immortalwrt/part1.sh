...
sed -i '$a src-git design https://github.com/gngpp/luci-theme-design' feeds.conf.default
sed -i '$a src-git designconfig https://github.com/gngpp/luci-app-design-config' feeds.conf.default
